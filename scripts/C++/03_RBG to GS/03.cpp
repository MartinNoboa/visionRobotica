...
void heading ()
{
     ...
     for (i=0; i<16; i++)
       ...
       printf("Date: March, 2023\n");
       printf("Author: Martin Noboa\n");
     for (i=0; i<3; i++)
       printf("+\n");
       return;
} // end heading ()
...
void openfiles ()
{
     ...
     printf(" Enter name of *.ppm INPUT image file (example: baboon.ppm) ");
     scanf("%s",infile);
     ...
     printf(" Enter name of *.pgm OUTPUT image file (example: baboon.pgm) ");
     scanf("%s",outfile);
...
//----------------------------------------------------------------------------//
//         Convertir una imagen RGB as Grayscale                              //
//----------------------------------------------------------------------------//
